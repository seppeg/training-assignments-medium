...
public class RDSJanitorResourceTracker implements JanitorResourceTracker {
	...
	private void updateResource(Resource resource, String json) {
		LOGGER.debug(String.format("Update statement is '%s'", createUpdateString()));
		int updated = this.jdbcTemplate.update(createUpdateString(),
	...
	private void addResource(Resource resource, String json) {
		LOGGER.debug(String.format("Insert statement is '%s'", createInsertString()));
		int updated = this.jdbcTemplate.update(createInsertString(),
                                 resource.getId(),
